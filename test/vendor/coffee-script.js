                  ...
                  return (
                    ...
                    (e.prototype.matchTags = function () {
                      ...
                      for (
                        ...
                        if (
                          null != i[n] &&
                          ('string' == typeof i[n] && (i[n] = [i[n]]), (o = this.tag(t + n + e)), 0 > v.call(i[n], o))
                        )
                          return !1
                      }
                      return !0
                    ...
                    (e.prototype.findTagsBackwards = function (e, t) {
                      ...
                      for (
                        ...
                        (n.length ||
                          ((a = this.tag(e)),
                          0 > v.call(t, a) &&
                            ((c = this.tag(e)), 0 > v.call(s, c) || this.tokens[e].generated) &&
                        ...
                        this.scanTokens(function (t, i, l) {
                          ...
                          if (
                            ...
                            (I = function (n, r) {
                              ...
                              return (
                                null == r && (r = !0),
                                (s = null != n ? n : i),
                                e.push(['{', s, { sameLine: !0, startsLine: r, ours: !0 }]),
                          ...
                          if (':' === $) {
                            ...
                            return (
                              ...
                              (D = B[0]),
                              (x = B[1]),
                              ('{' === D || ('INDENT' === D && '{' === this.tag(x - 1))) &&
                                (_ || ',' === this.tag(N - 1) || '{' === this.tag(N - 1)))
                                ? m(1)
                                : (I(N, !!_), m(2))
                            )
                          }
                      ...
                      return (
                        ...
                        (t = function (e, t) {
                          ...
                          return (
                            (';' !== e[1] &&
                              ((r = e[0]), v.call(p, r) >= 0) &&
                              !('TERMINATOR' === e[0] && ((s = this.tag(t + 1)), v.call(i, s) >= 0)) &&
                              !('ELSE' === e[0] && 'THEN' !== o) &&
                              !!(('CATCH' !== (a = e[0]) && 'FINALLY' !== a) || ('->' !== o && '=>' !== o))) ||
                            ((c = e[0]), v.call(n, c) >= 0 && this.tokens[t - 1].newLine)
                          )
                        }),
                        (e = function (e, t) {
                  ...
                  return (
                          ...
                          'own' === i && 'FOR' === this.tag()
                            ...
                            : ((n =
                              ...
                              !n &&
                                ...
                                ((p = i.toUpperCase()),
                                'WHEN' === p && ((m = this.tag()), nt.call(F, m) >= 0)
                                  ? (p = 'LEADING_WHEN')
                                  : 'FOR' === p
                                  ? (this.seenFor = !0)
                                  : 'UNLESS' === p
                                  ...
                                  : nt.call($, p) >= 0 &&
                                    ('INSTANCEOF' !== p && this.seenFor
                                      ...
                                      : ((p = 'RELATION'),
                                        '!' === this.value() && ((l = this.tokens.pop()), (i = '!' + i))))),
                              nt.call(w, i) >= 0 &&
                                (n
                                  ? ((p = 'IDENTIFIER'), (i = new String(i)), (i.reserved = !0))
                                  : nt.call(O, i) >= 0 && this.error('reserved word "' + i + '"')),
                              n ||
                                (nt.call(s, i) >= 0 && (i = o[i]),
                                (p = (function () {
                                  switch (i) {
                              ...
                              e && ((t = c.lastIndexOf(':')), this.token(':', ':', t, e.length)),
                              c.length))
                        : 0
                    }),
                    (e.prototype.numberToken = function () {
                      ...
                      return (n = A.exec(this.chunk))
                        ? ((i = n[0]),
                          /^0[BOX]/.test(i)
                            ? this.error("radix prefix '" + i + "' must be lowercase")
                            : /E/.test(i) && !/^0x/.test(i)
                            ? this.error("exponential notation '" + i + "' must be indicated with a lowercase 'e'")
                            : /^0\d*[89]/.test(i)
                    ...
                    (e.prototype.stringToken = function () {
                      ...
                      return (
                        (i = /^(?:\\.|[^\\])*\\(?:0[0-7]|[1-7])/.test(o)) &&
                          this.error('octal escape sequences ' + o + ' are not allowed'),
                        o.length
                      )
                    }),
                    (e.prototype.heredocToken = function () {
                      ...
                      return (n = u.exec(this.chunk))
                        ? ((t = n[0]),
                          (i = t.charAt(0)),
                          (e = this.sanitizeHeredoc(n[2], { quote: i, indent: null })),
                          '"' === i && e.indexOf('#{') >= 0
                            ? ((r = '\n' === n[2].charAt(0) ? 4 : 3),
                              this.interpolateString(e, { heredoc: !0, strOffset: r, lexedLength: t.length }))
                            : this.token('STRING', this.makeString(e, i, !0), 0, t.length),
                          t.length)
                        : 0
                    }),
                      ...
                      return (n = this.chunk.match(c))
                        ? ((e = n[0]),
                          ...
                          t &&
                            this.token(
                              'HERECOMMENT',
                              this.sanitizeHeredoc(t, { herecomment: !0, indent: J(' ', this.indent) }),
                              0,
                              e.length
                            ),
                          e.length)
                    ...
                    (e.prototype.jsToken = function () {
                      var e, t
                      return '`' === this.chunk.charAt(0) && (e = v.exec(this.chunk))
                    ...
                    (e.prototype.heregexToken = function () {
                      ...
                      if (((i = r[0]), (e = r[1]), (t = r[2]), 0 > e.indexOf('#{')))
                        return (
                          (a = this.escapeLines(e.replace(m, '$1$2').replace(/\//g, '\\/'), !0)),
                          a.match(/^\*/) && this.error('regular expressions cannot begin with `*`'),
                          this.token('REGEX', '/' + (a || '(?:)') + '/' + t, 0, i.length),
                          i.length
                        )
                      for (
                        this.token('IDENTIFIER', 'RegExp', 0, 0),
                          ...
                          l = [],
                          b = this.interpolateString(e, { regex: !0, strOffset: 3 }),
                          p = 0,
                          d = b.length;
                        d > p;
                        p++
                          ...
                          s
                            ? s === this.outdebt
                              ...
                              : ((r = this.indents.pop() + this.outdebt),
                                n && ((o = this.chunk[n]), nt.call(g, o) >= 0) && ((i -= r - e), (e = r)),
                                (this.outdebt = 0),
                                this.pair('OUTDENT'),
                    ...
                    (e.prototype.whitespaceToken = function () {
                      ...
                      return (e = q.exec(this.chunk)) || (t = '\n' === this.chunk.charAt(0))
                        ? ((n = z(this.tokens)), n && (n[e ? 'spaced' : 'newLine'] = !0), e ? e[0].length : 0)
                        : 0
                    }),
                    ...
                    (e.prototype.sanitizeHeredoc = function (e, t) {
                      ...
                      if (((r = t.indent), (i = t.herecomment))) {
                        if (
                          (p.test(e) && this.error('block comment cannot contain "*/", starting'), 0 > e.indexOf('\n'))
                        )
                          return e
                      } else
                        for (; (s = d.exec(e)); )
                    ...
                    (e.prototype.balancedString = function (e, t) {
                      ...
                      for (n = 0, a = [t], i = c = 1, h = e.length; h >= 1 ? h > c : c > h; i = h >= 1 ? ++c : --c)
                        if (n) --n
                          ...
                          '}' !== t || ('"' !== r && "'" !== r)
                            ? '}' === t && '/' === r && (s = f.exec(e.slice(i)) || _.exec(e.slice(i)))
                              ? (n += s[0].length - 1)
                              : '}' === t && '{' === r
                              ? a.push((t = '}'))
                              : '"' === t && '#' === o && '{' === r && a.push((t = '}'))
                    ...
                    (e.prototype.interpolateString = function (t, n) {
                      ...
                      for (
                        ...
                        '\\' !== u
                          ? '#' === u &&
                            ...
                            (a > g && C.push(this.makeToken('NEOSTRING', t.slice(g, a), T + g)),
                            r || (r = this.makeToken('', 'string interpolation', b + a + 1, 2)),
                            (c = s.slice(1, -1)),
                            c.length &&
                              ((D = this.getLineAndColumnFromChunk(T + a + 2)),
                              (d = D[0]),
                              (i = D[1]),
                              (m = new e().tokenize(c, { line: d, column: i, rewrite: !1 })),
                              (y = m.pop()),
                              'TERMINATOR' === (null != (S = m[0]) ? S[0] : void 0) && (y = m.shift()),
                              (l = m.length) &&
                                (l > 1 &&
                                  (m.unshift(this.makeToken('(', '(', T + a + 1, 0)),
                                  m.push(this.makeToken(')', ')', T + a + 1 + c.length, 0))),
                                C.push(['TOKENS', m]))),
                            (a += s.length),
                            (g = a + 1))
                          : (a += 1)
                      ...
                      for (
                        'NEOSTRING' !== C[0][0] && C.unshift(this.makeToken('NEOSTRING', '', b)),
                        ...
                        (L = C[a]),
                          ...
                          'TOKENS' === F
                            ...
                            : 'NEOSTRING' === F
                            ? ((L[0] = 'STRING'), (L[1] = this.makeString(N, '"', o)), this.tokens.push(L))
                    ...
                    (e.prototype.getLineAndColumnFromChunk = function (e) {
                      ...
                      return 0 === e
                        ...
                        : ((r = e >= this.chunk.length ? this.chunk : this.chunk.slice(0, +(e - 1) + 1 || 9e9)),
                          (n = W(r, '\n')),
                          (t = this.chunkColumn),
          ...
          n = (function () {
            ...
            var t = {
              ...
              parse: function (e) {
                ...
                this.parseError =
                  'function' == typeof this.yy.parseError ? this.yy.parseError : Object.getPrototypeOf(this).parseError
                for (var b, g, k, y, v, w, T, F, L, C = {}; ; ) {
                  if (
                    ((k = i[i.length - 1]),
                    this.defaultActions[k]
                      ? (y = this.defaultActions[k])
                      : ((null === b || b === void 0) && (b = t()), (y = o[k] && o[k][b])),
                  ...
                  switch (y[0]) {
                    ...
                    case 2:
                      if (
                        ...
                        m && (C._$.range = [s[s.length - (T || 1)].range[0], s[s.length - 1].range[1]]),
                        (v = this.performAction.apply(C, [a, h, c, this.yy, y[1], r, s].concat(d))),
                        v !== void 0)
                      )
                        return v
                    ...
                    (e.prototype.compileClosure = function (e) {
                      ...
                      return (
                        ...
                        ((i = this.contains(ct)) || this.contains(ht)) &&
                          ((n = [new D('this')]),
                          i ? ((h = 'apply'), n.push(new D('arguments'))) : (h = 'call'),
                    ...
                    (e.prototype.cache = function (e, t, n) {
                      ...
                      return this.isComplex()
                        ? ((r = new D(n || e.scope.freeVariable('ref'))),
                          (s = new i(r, this)),
                          t ? [s.compileToFragments(e, t), [this.makeCode(r.value)]] : [s, r])
                ...
                (function (e) {
                  ...
                  return (
                    ...
                    (t.prototype.compileNode = function (e) {
                      ...
                      for (
                        this.tab = e.indent, a = e.level === x, i = [], l = this.expressions, s = c = 0, h = l.length;
                        h > c;
                        s = ++c
                      )
                        (o = l[s]),
                          ...
                          o instanceof t
                            ...
                            ? ((o.front = !0),
                              ...
                              o.isStatement(e) || (r.unshift(this.makeCode('' + this.tab)), r.push(this.makeCode(';'))),
                              i.push(r))
                    ...
                    (t.prototype.compileRoot = function (e) {
                      ...
                      return (
                        ...
                        e.bare
                          ? n
                          : [].concat(s, this.makeCode('(function() {\n'), n, this.makeCode('\n}).call(this);\n'))
                      )
                    }),
                    (t.prototype.compileWithDeclarations = function (e) {
                      var t, n, i, r, s, o, a, c, h, u, p, d, f, m
                      for (
                        r = [], o = [], d = this.expressions, s = u = 0, p = d.length;
                        p > u && ((i = d[s]), (i = i.unwrap()), i instanceof l || i instanceof D);
                        s = ++u
                      );
                      return (
                        (e = pt(e, { level: x })),
                          ...
                          n || t
                            ? (s && r.push(this.makeCode('\n')),
                              ...
                              t &&
                                ...
                                r.push(this.makeCode(c.assignedVariables().join(',\n' + (this.tab + X))))),
                      ...
                      return (
                        ...
                        2 > this.properties.length && !this.base.isComplex() && !(null != s ? s.isComplex() : void 0)
                          ...
                          : ((n = new t(this.base, this.properties.slice(0, -1))),
                            n.isComplex() &&
                              ((r = new D(e.scope.freeVariable('base'))), (n = new t(new j(new i(r, n))))),
                            s
                              ? (s.isComplex() &&
                    ...
                    (t.prototype.compileNode = function (e) {
                      ...
                      for (
                        this.base.front = this.front,
                          i = this.properties,
                          t = this.base.compileToFragments(e, i.length ? F : null),
                          (this.base instanceof j || i.length) && P.test(at(t)) && t.push(this.makeCode('.')),
                          r = 0,
                          s = i.length;
                        s > r;
                        r++
                      ...
                      return (
                        ...
                        this.isSuper
                          ...
                          : (this.isNew && s.push(this.makeCode('new ')),
                            s.push.apply(s, this.variable.compileToFragments(e, F)),
                        ...
                        : ((n = []),
                          ...
                          (o = i.properties.pop()) && i.isComplex()
                            ...
                            : ((r = i.compileToFragments(e, F)),
                              ...
                              o ? ((a = at(r)), r.push.apply(r, o.compileToFragments(e))) : (a = 'null'),
                              (n = n.concat(r))),
                  ...
                  return (
                    ...
                    (t.prototype.compileVariables = function (e) {
                      ...
                      return (
                        ...
                        (this.toVar = i[1]),
                        (t = it(e, 'step')) &&
                          ((r = this.cacheToCodeFragments(t.cache(e, C))), (this.step = r[0]), (this.stepVar = r[1])),
                      ...
                      return this.fromNum && this.toNum && 20 >= Math.abs(this.fromNum - this.toNum)
                        ...
                        : ((o = this.tab + X),
                          ...
                          this.fromNum && this.toNum
                            ...
                            : ((u = '' + s + ' = ' + this.fromC + (this.toC !== this.toVar ? ', ' + this.toC : '')),
                          ...
                          (this.range.exclusive || -1 !== +n) &&
                            (o =
                              ...
                              (this.range.exclusive
                                ...
                                : P.test(n)
                                ? '' + (+n + 1)
                                : ((t = s.compileToFragments(e, F)), '+' + at(t) + ' + 1 || 9e9')))),
                ...
                (function (e) {
                  ...
                  return (
                    ...
                    (t.prototype.compileNode = function (e) {
                      ...
                      for (
                        r = e.indent += X, a = this.lastNonComment(this.properties), t = [], n = d = 0, m = u.length;
                        m > d;
                        n = ++d
                      )
                        (h = u[n]),
                          (o = n === u.length - 1 ? '' : h === a || h instanceof l ? '\n' : ',\n'),
                          (s = h instanceof l ? '' : r),
                          h instanceof i &&
                            h.variable instanceof Z &&
                            h.variable.hasProperties() &&
                            h.variable.error('Invalid object key'),
                          h instanceof Z && h['this'] && (h = new i(h.properties[0].name, h, 'object')),
                          h instanceof l ||
                    ...
                    (n.prototype.determineName = function () {
                      ...
                      return this.variable
                        ? ((e = (n = lt(this.variable.properties))
                          ...
                          Lt.call(U, e) >= 0 && this.variable.error('class variable name may not be ' + e),
                          e && (e = b.test(e) && e))
                        : null
                    }),
                    ...
                    (n.prototype.addBoundFunctions = function (e) {
                      ...
                      for (o = this.boundFuncs, r = 0, s = o.length; s > r; r++)
                        (n = o[r]),
                          ...
                          this.ctor.body.unshift(new D('' + i + ' = ' + yt('bind') + '(' + i + ', this)'))
                    }),
                        ...
                        (a = function () {
                          ...
                          for (e = []; (s = l.shift()); )
                            s instanceof i &&
                              ...
                              (h = s.value),
                              'constructor' === o.value
                                ? (this.ctor && s.error('cannot define more than one constructor in a class'),
                                  h.bound && s.error('cannot define a constructor as a bound function'),
                                  h instanceof c
                                    ? (s = this.ctor = h)
                                ...
                                : s.variable['this']
                                ? (h['static'] = !0)
                                : ((s.variable = new Z(new D(n), [new t(new D('prototype')), new t(o)])),
                                  h instanceof c && h.bound && (this.boundFuncs.push(o), (h.bound = !1)))),
                              e.push(s)
                          return e
                        }.call(this)),
                        nt(a)
                              ...
                              for (d = c = o.expressions, h = u = 0, p = d.length; p > u; h = ++u)
                                (l = d[h]),
                                  l instanceof i && l.variable.looksStatic(e)
                                    ? (l.value['static'] = !0)
                                    : l instanceof Z && l.isObject(!0) && ((a = !1), (c[h] = r.addProperties(l, e, t)))
                    ...
                    (n.prototype.ensureConstructor = function (e) {
                      return (
                        this.ctor ||
                          ((this.ctor = new c()),
                          this.externalCtor
                            ? this.ctor.body.push(new D('' + this.externalCtor + '.apply(this, arguments)'))
                            : this.parent &&
                              this.ctor.body.push(new D('' + e + '.__super__.constructor.apply(this, arguments)')),
                ...
                (function (e) {
                  ...
                  return (
                    ...
                    (n.prototype.isStatement = function (e) {
                      return (
                        (null != e ? e.level : void 0) === x && null != this.context && Lt.call(this.context, '?') >= 0
                      )
                    }),
                    ...
                    (n.prototype.compileNode = function (e) {
                      ...
                      return (
                        ...
                        this.context ||
                          ...
                          ('function' == typeof a.hasProperties ? a.hasProperties() : void 0) ||
                            (this.param ? e.scope.add(s, 'var') : e.scope.find(s))),
                        this.value instanceof c &&
                          (r = S.exec(s)) &&
                          (r[2] && (this.value.klass = r[1]),
                          (this.value.name = null != (u = null != (p = r[3]) ? p : r[4]) ? u : r[5])),
                    ...
                    (n.prototype.compilePatternMatch = function (e) {
                      ...
                      if (((l = this.variable.isObject()), v && 1 === g && !((f = m[0]) instanceof G)))
                        return (
                          f instanceof n
                            ? ((A = f), (I = A.variable), (h = I.base), (f = A.value))
                            : (h = l ? (f['this'] ? f.properties[0].name : f) : new D(0)),
                          (i = b.test(h.unwrap().value || 0)),
                          (F = new Z(F)),
                          F.properties.push(new (i ? t : T)(h)),
                          (_ = f.unwrap().value),
                          Lt.call(M, _) >= 0 && f.error('assignment to a reserved word: ' + f.compile(e)),
                          new n(f, F, null, { param: this.param }).compileToFragments(e, x)
                        )
                      for (
                        L = F.compileToFragments(e, C),
                          ...
                          (!b.test(E) || this.variable.assigns(E)) &&
                            (r.push([this.makeCode('' + (k = e.scope.freeVariable('ref')) + ' = ')].concat(Ct.call(L))),
                            (L = [this.makeCode(k)]),
                            (E = k)),
                          c = S = 0,
                          R = m.length;
                        ...
                        if (
                          ...
                          l &&
                            (f instanceof n
                              ? (($ = f), (O = $.variable), (h = O.base), (f = $.value))
                              : f.base instanceof j
                              ? ((B = new Z(f.unwrapAll()).cacheReference(e)), (f = B[0]), (h = B[1]))
                              : (h = f['this'] ? f.properties[0].name : f)),
                          !o && f instanceof G)
                        )
                          (d = f.name.unwrap().value),
                            (f = f.unwrap()),
                            (w = '' + g + ' <= ' + E + '.length ? ' + yt('slice') + '.call(' + E + ', ' + c),
                            (y = g - c - 1)
                        ...
                        null != d && Lt.call(M, d) >= 0 && f.error('assignment to a reserved word: ' + f.compile(e)),
                          r.push(new n(f, w, null, { param: this.param, subpattern: !0 }).compileToFragments(e, C))
                      }
                      return (
                      ...
                      return (
                        ...
                        Lt.call(this.context, '?') >= 0
                          ? ((e.isExistentialEquals = !0),
                            new v(new u(i), r, { type: 'if' }).addElse(new n(r, this.value, '=')).compileToFragments(e))
                          : ((t = new $(this.context.slice(0, -1), i, new n(r, this.value, '=')).compileToFragments(e)),
                            C >= e.level ? t : this.wrapInBraces(t))
                      )
                    }),
                    ...
                    (n.prototype.compileSplice = function (e) {
                      ...
                      return (
                        ...
                        a
                          ? i instanceof Z && i.isSimpleNumber() && a instanceof Z && a.isSimpleNumber()
                            ? ((a = a.compile(e) - s), n || (a += 1))
                            : ((a = a.compile(e, F) + ' - ' + s), n || (a += ' + 1'))
                          : (a = '9e9'),
                        (p = this.value.cache(e, C)),
                        (c = p[0]),
                        (h = p[1]),
                        (t = [].concat(
                          this.makeCode('[].splice.apply(' + o + ', [' + r + ', ' + a + '].concat('),
                          c,
                          this.makeCode(')), '),
                          h
                        )),
                  ...
                  return (
                    ...
                    (t.prototype.compileNode = function (e) {
                      ...
                      if (
                        ...
                        return (
                          (this.context = '_this'),
                          (T = new t([new O(new D(this.context))], new s([this]))),
                      ...
                      for (P = this.params, C = 0, S = P.length; S > C; C++)
                        if (((f = P[C]), f.splat || f instanceof p)) {
                          for (U = this.params, N = 0, R = U.length; R > N; N++)
                            (d = U[N].name),
                              f instanceof p ||
                                (d['this'] && (d = d.properties[0].name), d.value && e.scope.add(d.value, 'var', !0))
                          g = new i(
                            new Z(
                              new n(
                                function () {
                      ...
                      for (
                        w = this.body.isEmpty(),
                          g && h.unshift(g),
                          h.length && (q = this.body.expressions).unshift.apply(q, h),
                          l = j = 0,
                          I = m.length;
                        I > j;
                        l = ++j
                        ...
                        : ((t = this.name),
                          t['this']
                            ? ((t = t.properties[0].name),
                              t.value.reserved && (t = new D(e.scope.freeVariable(t.value))))
                            : t.isComplex() && (t = new D(e.scope.freeVariable('arg'))),
                          (t = new Z(t)),
                      ...
                      for (c = t.objects, o = 0, a = c.length; a > o; o++)
                        (s = c[o]),
                          s instanceof i
                            ...
                            : s instanceof p || s.error('illegal parameter ' + s.compile())
                    }),
                    t
                  )
                })(r)),
                    ...
                    (t.compileSplattedArray = function (e, n, i) {
                      ...
                      if (1 === n.length)
                        return (
                          ...
                          i ? c : [].concat(u.makeCode('' + yt('slice') + '.call('), c, u.makeCode(')'))
                        )
                      for (r = n.slice(l), h = p = 0, d = r.length; d > p; h = ++p)
                        (u = r[h]),
                          ...
                          (r[h] =
                            u instanceof t
                              ? [].concat(u.makeCode('' + yt('slice') + '.call('), o, u.makeCode(')'))
                      ...
                      return 0 === l
                        ...
                        : ((s = (function () {
                          ...
                          [].concat(n[0].makeCode('['), s, n[l].makeCode('].concat('), a, lt(n).makeCode(')')))
                    }),
                    t
                  )
                })(r)),
                          ...
                          : (this.returns &&
                            ...
                            this.guard &&
                              (n.expressions.length > 1
                                ? n.expressions.unshift(new v(new j(this.guard).invert(), new D('continue')))
                                : this.guard && (n = s.wrap([new v(this.guard, n)]))),
                            (n = [].concat(
                              this.makeCode('\n'),
                ...
                (function (e) {
                  ...
                  return (
                    ...
                    (n.prototype.generateDo = function (e) {
                      ...
                      for (
                        s = [],
                          n = e instanceof i && (a = e.value.unwrap()) instanceof c ? a : e,
                          u = n.params || [],
                          h = 0,
                          l = u.length;
                        l > h;
                    ...
                    (n.prototype.compileNode = function (e) {
                      ...
                      if (
                        ...
                        ('--' === (s = this.operator) || '++' === s) &&
                          ((o = this.first.unwrapAll().value), Lt.call(U, o) >= 0) &&
                    ...
                    (n.prototype.compileExistence = function (e) {
                      ...
                      return (
                        this.first.isComplex()
                          ? ((n = new D(e.scope.freeVariable('ref'))), (t = new j(new i(n, this.first))))
                          : ((t = this.first), (n = t)),
                        new v(new u(t), n, { type: 'if' }).addElse(this.second).compileToFragments(e)
                      )
                    }),
                  ...
                  return (
                    ...
                    (t.prototype.compileOrTest = function (e) {
                      ...
                      for (
                        ...
                        (r = p[i]),
                          ...
                          (a = a.concat(i ? s : o, this.makeCode(t), r.compileToFragments(e, F)))
                    ...
                    (t.prototype.compileLoopTest = function (e) {
                      ...
                      return (
                        ...
                        at(i) === at(n)
                          ? t
                          : ((t = i.concat(this.makeCode(', '), t)), C > e.level ? t : this.wrapInBraces(t))
                      )
                    }),
                      ...
                      return (
                        ...
                        n instanceof Z && n.isAtomic()
                          ...
                          : ((i = n.compileToFragments(e, E)),
                            (t = N > e.level && (n instanceof $ || n instanceof o || (n instanceof f && n.returns))),
                ...
                (function (e) {
                  function t(e, t) {
                    ...
                    ;(this.source = t.source),
                      ...
                      (this.range =
                        this.source instanceof Z && this.source.base instanceof B && !this.source.properties.length),
                  ...
                  return (
                    ...
                    (t.prototype.compileNode = function (e) {
                      ...
                      return (
                        ...
                        (f = this.tab + X),
                        this.range
                          ? (p = $.compileToFragments(pt(e, { index: k, name: L, step: this.step })))
                          : ((P = this.source.compile(e, C)),
                            (!L && !this.own) ||
                              b.test(P) ||
                              ((h += '' + this.tab + (E = _.freeVariable('ref')) + ' = ' + P + ';\n'), (P = E)),
                            L && !this.pattern && (N = '' + L + ' = ' + P + '[' + y + ']'),
                            this.object ||
                              (O !== B && (h += '' + this.tab + O + ';\n'),
                              (this.step && M && (u = 0 > ft(M[0]))) || (F = _.freeVariable('len')),
                              (a = '' + w + k + ' = 0, ' + F + ' = ' + P + '.length'),
                              (c = '' + w + k + ' = ' + P + '.length - 1'),
                              (r = '' + k + ' < ' + F),
                              (o = '' + k + ' >= 0'),
                        ...
                        this.guard &&
                          (t.expressions.length > 1
                            ? t.expressions.unshift(new v(new j(this.guard).invert(), new D('continue')))
                    ...
                    (t.prototype.pluckDirectCall = function (e, t) {
                      ...
                      for (r = [], f = t.expressions, h = p = 0, d = f.length; d > p; h = ++p)
                        (s = f[h]),
                          (s = s.unwrapAll()),
                          s instanceof o &&
                            ((u = null != (m = s.variable) ? m.unwrapAll() : void 0),
                            (u instanceof c ||
                              (u instanceof Z &&
                                (null != (b = u.base) ? b.unwrapAll() : void 0) instanceof c &&
                                1 === u.properties.length &&
                                ('call' === (g = null != (k = u.properties[0].name) ? k.value : void 0) ||
                                  'apply' === g))) &&
                              ((a = (null != (y = u.base) ? y.unwrapAll() : void 0) || u),
                              (l = new D(e.scope.freeVariable('fn'))),
                              (n = new Z(l)),
                              u.base && ((v = [n, u]), (u.base = v[0]), (n = v[1])),
                ...
                (function (e) {
                  ...
                  return (
                    ...
                    (t.prototype.makeReturn = function (e) {
                      ...
                      return (
                        e && (this.otherwise || (this.otherwise = new s([new D('void 0')]))),
                    ...
                    (t.prototype.compileNode = function (e) {
                      ...
                      for (
                        c = e.indent + X,
                          ...
                          o = [].concat(
                            ...
                            this.subject ? this.subject.compileToFragments(e, E) : this.makeCode('false'),
                            this.makeCode(') {\n')
                          ),
                          f = this.cases,
                          a = l = 0,
                        ...
                        for (m = f[a], r = m[0], t = m[1], b = ot([r]), u = 0, d = b.length; d > u; u++)
                          (i = b[u]),
                            ...
                            (o = o.concat(this.makeCode(c + 'case '), i.compileToFragments(e, E), this.makeCode(':\n')))
                        if (
                          ((n = t.compileToFragments(e, x)).length > 0 && (o = o.concat(n, this.makeCode('\n'))),
                          a === this.cases.length - 1 && !this.otherwise)
                        )
                          break
                        ;(s = this.lastNonComment(t.expressions)),
                          s instanceof V ||
                            (s instanceof D && s.jumps() && 'debugger' !== s.value) ||
                      ...
                      return (
                        this.otherwise &&
                          ...
                          o.push.apply(
                            o,
                            [this.makeCode(c + 'default:\n')].concat(Ct.call(this.otherwise.compileToFragments(e, x)), [
                              this.makeCode('\n'),
                            ])
                          ),
              ...
              (e.If = v =
                (function (e) {
                  ...
                  return (
                    ...
                    (t.prototype.makeReturn = function (e) {
                      return (
                        e && (this.elseBody || (this.elseBody = new s([new D('void 0')]))),
                      ...
                      return (
                        ...
                        (o = it(e, 'isExistentialEquals'))
                          ...
                          : ((c = e.indent + X),
                            ...
                            (i = this.ensureBlock(this.body).compileToFragments(pt(e, { indent: c }))),
                            (a = [].concat(
                              this.makeCode('if ('),
                              s,
                              this.makeCode(') {\n'),
                            ...
                            this.elseBody
                              ? ((n = a.concat(this.makeCode(' else '))),
                                this.isChain
                                  ? ((e.chainChild = !0),
                                    (n = n.concat(this.elseBody.unwrap().compileToFragments(e, x))))
                                  : (n = n.concat(
                                      this.makeCode('{\n'),
                                      this.elseBody.compileToFragments(pt(e, { indent: c }), x),
                                      this.makeCode('\n' + this.tab + '}')
                                    )),
                                n)
                              : a)
            ...
            if (
                ...
                f(function (e, t) {
                  ...
                  for (
                    ...
                    (a = u[g]),
                      t.sourceMap &&
                        (a.locationData &&
                          f.add([a.locationData.first_line, a.locationData.first_column], [s, r], { noReplace: !0 }),
                        (b = c.count(a.code, '\n')),
                        (s += b),
                        b ? (r = a.code.length - (a.code.lastIndexOf('\n') + 1)) : (r += a.code.length)),
                      (d += a.code)
                  return (
                    t.header && ((p = 'Generated by CoffeeScript ' + this.VERSION), (d = '// ' + p + '\n' + d)),
                    t.sourceMap ? ((i = { js: d }), (i.sourceMap = f), (i.v3SourceMap = f.generate(t, e)), i) : d
                  )
                })),
              ...
              (e.run = function (e, t) {
                ...
                return (
                  null == t && (t = {}),
                  (s = require.main),
                  (s.filename = process.argv[1] = t.filename ? o.realpathSync(t.filename) : '.'),
                  s.moduleCache && (s.moduleCache = {}),
                  (r = t.filename ? u.dirname(o.realpathSync(t.filename)) : o.realpathSync('.')),
                  (s.paths = require('module')._nodeModulePaths(r)),
                  (!c.isCoffee(s.filename) || require.extensions) && ((n = i(e, t)), (e = null != (a = n.js) ? a : n)),
                  ...
                  for (
                    a = window.document.getElementsByTagName('script'),
                      ...
                      n = function () {
                        var t
                        return (
                          (t = e[r]), t instanceof Array ? (CoffeeScript.run.apply(CoffeeScript, t), r++, n()) : void 0
                        )
                      },
                      c = function (i, r) {
                        var s
